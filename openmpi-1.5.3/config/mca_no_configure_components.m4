...
m4_define([mca_opal_framework_list], [backtrace, carto, crs, installdirs, maffinity, memchecker, memcpy, memory, paffinity, pstat, sysinfo, timer])
...
m4_define([mca_ess_m4_config_component_list], [portals_utcp, cnos, alps, env, hnp, lsf, singleton, slave, slurm, slurmd, tm, tool])
...
m4_define([mca_grpcomm_m4_config_component_list], [cnos, bad, basic, hier])
...
m4_define([mca_plm_m4_config_component_list], [alps, ccp, lsf, process, rsh, rshd, slurm, tm])
...
m4_define([mca_rmcast_no_config_component_list], [tcp, udp])
m4_define([mca_rmcast_m4_config_component_list], [])
...
m4_define([mca_orte_framework_list], [errmgr, ess, filem, grpcomm, iof, notifier, odls, oob, plm, ras, rmaps, rmcast, rml, routed, snapc])
...
m4_define([mca_mpool_m4_config_component_list], [pcie])
...
AC_CONFIG_FILES(orte/mca/rmcast/Makefile)
dnl ----------------------------------------------------------------

dnl No-configure component: 
dnl    orte/mca/rmcast/tcp

AC_CONFIG_FILES([orte/mca/rmcast/tcp/Makefile])
dnl ----------------------------------------------------------------

dnl No-configure component: 
dnl    orte/mca/rmcast/udp
...
dnl m4-configure component: 
dnl    ompi/mca/mpool/pcie

AC_CONFIG_FILES([ompi/mca/mpool/pcie/Makefile])
dnl ----------------------------------------------------------------
